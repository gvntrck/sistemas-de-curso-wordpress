...
class System_Cursos_Access_Control
{
    ...
    public static function revoke_access($user_id, $curso_id)
    {
        global $wpdb;
        $table_name = $wpdb->prefix . 'acesso_cursos';
    ...
    public static function suspend_access($user_id, $curso_id)
    {
        global $wpdb;
        $table_name = $wpdb->prefix . 'acesso_cursos';
            ...
            if ($user_id > 0 && $curso_id > 0) {
                switch ($acao) {
                    ...
                    case 'reativar':
                        ...
                        break;
                    case 'suspender':
                        self::suspend_access($user_id, $curso_id);
                        break;
                    case 'revogar':
                        self::revoke_access($user_id, $curso_id);
                        break;
                }
