        ...
        ?>
                <div class="wrap">
                    ...
                    <div style="background: #fff; border: 1px solid #ccd0d4; border-radius: 4px; padding: 20px; margin: 20px 0;">
                        ...
                        <p class="description">Abaixo estão listadas as aulas onde o aluno já realizou tentativas de quiz. Você pode resetar para permitir novos envios.</p>
                                ...
                                <table class="wp-list-table widefat fixed striped">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($quiz_attempts_metas as $meta) {
                                            ...
                                            $max_tentativas = (int) get_post_meta($aula_id, 'quiz_tentativas', true);
                                            if ($max_tentativas <= 0)
                                                $max_tentativas = 1; // Fallback
                            
                                            $nota = get_user_meta($user_id, '_quiz_score_' . $aula_id, true);
                                            $nota_minima = (int) get_post_meta($aula_id, 'quiz_nota_minima', true);
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <strong><?php echo $tentativas_usadas; ?></strong> / <?php echo $max_tentativas; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo ($nota !== '') ? $nota . '%' : '-'; ?>
                                                    ...
                                                    <td>
                                                        <?php if ($tentativas_usadas > 0): ?>
                                                                <form method="post" onsubmit="return confirm('Tem certeza que deseja ZERAR as tentativas desta aula para este aluno?');">
                                                                    ...
                                                                    <button type="submit" class="button button-secondary">
                                                                        <span class="dashicons dashicons-image-rotate" style="vertical-align: text-top;"></span> Resetar Tentativas
                                                                    </button>
                                                                </form>
                                                        <?php else: ?>
