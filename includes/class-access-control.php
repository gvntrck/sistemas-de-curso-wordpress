                                                ...
                                                <div style="background:#fff; padding:20px; border-radius:4px; min-width:450px; max-width:90%;">
                                                    ...
                                                    <div style="margin-bottom: 15px;">
                                                        ...
                                                        <div style="display: flex; gap: 15px;">
                                                            <label><input type="radio" name="lote_acao_modal" value="add" checked onchange="document.getElementById('div-data-fim').style.display='block'"> Matricular</label>
                                                            <label><input type="radio" name="lote_acao_modal" value="remove" onchange="document.getElementById('div-data-fim').style.display='none'"> Desmatricular</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div style="display: flex; gap: 20px; margin-bottom: 15px;">
                                                        <div style="flex: 1;">
                                                            ...
                                                            <div style="max-height: 150px; overflow-y: auto; border: 1px solid #ccd0d4; padding: 10px; border-radius: 4px; background: #fafafa;">
                                                                <?php foreach ($cursos as $curso): ?>
                                                    ...
                                                    <div style="display: flex; gap: 10px; justify-content: flex-end; margin-top: 20px;">
                                                        ...
                                                        <button type="button" class="button button-primary" onclick="confirmarAcaoLote()">Confirmar Ação em Lote</button>
                                                    </div>
                                                </div>
                                            </div>
