...
class System_Cursos_Customizer
{
    ...
    public static function get_presets()
    {
        return [
            ...
            'clean_daylight' => [
                'name'  => 'Clean Daylight',
                'desc'  => 'Branco puro com azul corporativo — limpo e profissional.',
                'emoji' => '☀️',
                'colors' => [
                    'color_bg_primary'      => '#FFFFFF',
                    'color_bg_secondary'    => '#F8FAFC',
                    'color_bg_tertiary'     => '#F1F5F9',
                    'color_bg_header_start' => '#FFFFFF',
                    'color_bg_header_end'   => '#F8FAFC',
                    'color_bg_footer'       => '#F1F5F9',
                    'color_text_primary'    => '#334155',
                    'color_text_heading'    => '#0F172A',
                    'color_text_muted'      => '#94A3B8',
                    'color_text_label'      => '#64748B',
                    'color_accent'          => '#2563EB',
            ...
            'warm_sand' => [
                'name'  => 'Warm Sand',
                'desc'  => 'Tons quentes de areia com terracota — acolhedor e orgânico.',
                'emoji' => '🏖️',
                'colors' => [
                    'color_bg_primary'      => '#FFFBF5',
                    'color_bg_secondary'    => '#FEF7ED',
                    'color_bg_tertiary'     => '#FFF7E6',
                    'color_bg_header_start' => '#FFFBF5',
                    'color_bg_header_end'   => '#FEF7ED',
                    'color_bg_footer'       => '#FEF3E2',
                    'color_text_primary'    => '#44403C',
                    'color_text_heading'    => '#1C1917',
                    'color_text_muted'      => '#A8A29E',
                    'color_text_label'      => '#78716C',
                    'color_accent'          => '#C2410C',
                    'color_accent_hover'    => '#9A3412',
                    'color_success'         => '#15803D',
                    'color_error'           => '#B91C1C',
                    'color_border'          => '#E7E5E4',
                    'color_border_input'    => '#D6D3D1',
                ],
            ],
            'mint_fresh' => [
                'name'  => 'Mint Fresh',
                'desc'  => 'Verde menta suave com fundo claro — leve e revigorante.',
                'emoji' => '🍃',
                'colors' => [
                    'color_bg_primary'      => '#F0FDF4',
                    'color_bg_secondary'    => '#F7FEF9',
                    'color_bg_tertiary'     => '#ECFDF5',
                    'color_bg_header_start' => '#F0FDF4',
                    'color_bg_header_end'   => '#F7FEF9',
                    'color_bg_footer'       => '#ECFDF5',
                    'color_text_primary'    => '#374151',
                    'color_text_heading'    => '#111827',
                    'color_text_muted'      => '#9CA3AF',
                    'color_text_label'      => '#6B7280',
                    'color_accent'          => '#059669',
                    'color_accent_hover'    => '#047857',
                    'color_success'         => '#16A34A',
                    'color_error'           => '#DC2626',
                    'color_border'          => '#D1FAE5',
                    'color_border_input'    => '#A7F3D0',
                ],
            ],
        ];
    }
