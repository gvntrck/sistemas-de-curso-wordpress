...
function sdc_campos_registro_usuario() {
    ...
    <p>
        <label for="cpf"><?php _e('CPF', 'textdomain'); ?><br />
            <input type="text" name="cpf" id="cpf" class="input" value="<?php echo esc_attr($cpf); ?>" size="25" placeholder="000.000.000-00" />
        </label>
    </p>
    
    <p>
        <label for="aniversario"><?php _e('Data de Aniversário', 'textdomain'); ?><br />
            <input type="date" name="aniversario" id="aniversario" class="input" value="<?php echo esc_attr($aniversario); ?>" size="25" />
        </label>
    </p>
    
    <p>
        <label for="instagram"><?php _e('Instagram', 'textdomain'); ?><br />
            <input type="text" name="instagram" id="instagram" class="input" value="<?php echo esc_attr($instagram); ?>" size="25" placeholder="@seuusuario" />
        </label>
    </p>
    
    <p>
        <label for="cep"><?php _e('CEP', 'textdomain'); ?><br />
            <input type="text" name="cep" id="cep" class="input" value="<?php echo esc_attr($cep); ?>" size="25" placeholder="00000-000" />
        </label>
    </p>
    ...
    <p>
        <label for="complemento"><?php _e('Complemento', 'textdomain'); ?><br />
            <input type="text" name="complemento" id="complemento" class="input" value="<?php echo esc_attr($complemento); ?>" size="25" />
        </label>
    </p>
...
function sdc_campos_edicao_perfil($user) {
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                <input type="text" name="cpf" id="cpf" value="<?php echo esc_attr($cpf); ?>" class="regular-text" placeholder="000.000.000-00" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="date" name="aniversario" id="aniversario" value="<?php echo esc_attr($aniversario); ?>" class="regular-text" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="instagram" id="instagram" value="<?php echo esc_attr($instagram); ?>" class="regular-text" placeholder="@seuusuario" />
            </td>
        </tr>
    </table>
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                <input type="text" name="cep" id="cep" value="<?php echo esc_attr($cep); ?>" class="regular-text" placeholder="00000-000" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="complemento" id="complemento" value="<?php echo esc_attr($complemento); ?>" class="regular-text" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="bairro" id="bairro" value="<?php echo esc_attr($bairro); ?>" class="regular-text" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="cidade" id="cidade" value="<?php echo esc_attr($cidade); ?>" class="regular-text" />
            </td>
        </tr>
