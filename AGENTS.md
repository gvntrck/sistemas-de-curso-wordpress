...
- `documentacao.txt/` — explain what lives here and when agents should edit it.
- `includes/` — explain what lives here and when agents should edit it.
- `modelo.html/` — explain what lives here and when agents should edit it.
- `roadmap.txt/` — explain what lives here and when agents should edit it.
- `sistema-cursos-plugin.php/` — explain what lives here and when agents should edit it.
